...
const CreateTwo = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // First create the property on blockchain
      ...
      const postData = {
        accountAddress: currentAccount, // Add MetaMask account address
        propertyTitle,
        description,
        category,
        price: form.price, // Use original price value (not parsed)
        images,
        propertyAddress,
        coverImage: "your-cover-image-url", // Add actual cover image URL
        featuredImage: "your-featured-image-url", // Add actual featured image URL
      };
